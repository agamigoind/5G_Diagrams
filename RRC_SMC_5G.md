...
sequenceDiagram
   ...
   note over UE,AMF: Pre-condition: 5G-AKA or EAP-AKA' completed.<br/>NAS security active; AMF holds K_AMF.<br/>AS key material available: K_gNB or NH/NCC derived from K_AMF.<br/>UE Security Capabilities available for delivery to gNB. end
